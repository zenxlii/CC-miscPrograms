...
addRecipe({"minecraft:sticky_piston",1},64,{"minecraft:slime_ball",nil,nil,n.piston})
...
addRecipe({"create:mechanical_drill",1},64,{nil,n.andAlloy,nil,n.andAlloy,n.iron,n.andAlloy,nil,n.aCasing})
